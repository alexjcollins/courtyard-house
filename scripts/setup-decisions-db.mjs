...
const ROOM_GROUP_ORDER = {
  ...
  "Guest bedroom 1": 90,
  "Guest bedroom 2": 100,
  "Guest shower room": 110,
  "Powder room": 120,
  Garage: 130,
  "Courtyard / external interface": 140,
}
...
function buildSeedItems() {
  ...
  addItem({
    ...
    categoryId: "finishes",
    roomGroup: "Principal suite",
    roomSection: "Bedroom",
    roomName: "Principal suite",
    typeGroup: "Floors, walls & decorating",
  ...
  addBathroom({
    addItem,
    roomGroup: "Principal suite",
    roomLabel: "Principal suite ensuite",
    hasBath: false,
    wcBudget: 1000,
    basinBudget: 1800,
    tapBudget: 700,
  ...
  addBathroom({
    addItem,
    roomGroup: "Family bathroom",
    roomLabel: "Family bathroom",
    hasBath: true,
    wcBudget: 900,
    basinBudget: 1200,
    tapBudget: 500,
  ...
  addBathroom({
    addItem,
    roomGroup: "Guest shower room",
    roomLabel: "Guest shower room / ensuite",
    hasBath: false,
    wcBudget: 900,
    basinBudget: 1200,
    tapBudget: 500,
